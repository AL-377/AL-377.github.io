...
# 🔥 News
- 🌟 [2026.06.23]: We released **Seed 2.1**, an agent model designed for **productivity scenarios**. As a core contributor, I focused on enhancing delivery capabilities for high-value office work and complex everyday consultations (gdpval: 87.9, apexagent: 33.8), while also rolling out the model's capabilities to the Office Task mode in the Doubao app. For more details, please refer to the [model card](https://lf3-static.bytednsdoc.com/obj/eden-cn/lapzild-tss/ljhwZthlaukjlkulzlp/seed2.1/Seed2_1_Model_Card.pdf) and [website](https://seed.bytedance.com/en/seed2_1).
- 🔥 [2026.04.21]: **Agent-World** featured as 🤗 [HF Daily Paper #2](https://huggingface.co/papers/2604.18292) ! It is the first **self-evolving training arena** for general agents. Agent-World-14B achieves 55.8% on BFCL-V4 (surpassing DeepSeek-V3.2-685B), 65.4% on tau²-Bench and outperforms all open-source baselines across 23 agent benchmarks. It exhibits **strong generalization** in General Reasoning, Agentic Search & Coding domains, and delivers significant improvements in advanced agentic assistant scenarios such as **SkillsBench** and **ClawEval**. More details refer to our [paper](https://arxiv.org/pdf/2604.18292) and [demo](https://agent-tars-world.github.io/-/).
...
- **Seed 2.1 Model Card: Agentic Intelligence for Productivity** \
 Seed Team **(core contributor)** \
 Model card 2026, [[Paper](https://lf3-static.bytednsdoc.com/obj/eden-cn/lapzild-tss/ljhwZthlaukjlkulzlp/seed2.1/Seed2_1_Model_Card.pdf)]
